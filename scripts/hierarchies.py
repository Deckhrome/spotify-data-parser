...
popularity_hierarchy = {
    ...
    "rootnode": {
        ...
        "child_nodes": [
            {
                "tag_id": "veryunpopular",
                "child_nodes": [],
            },  # 0 - 5 (Scores from 0 to 5 included)
...
def build_hierarchies(class_manager):
    for hierarchy in all_hierarchies:
        ...
        associate_tag_with_id(
            hierarchy["rootnode"], class_manager, tagset_id, hierarchy_name
        )
